export default function VoiceLoading() {
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-96 h-96 bg-emerald-100/40 rounded-full blur-3xl -me-20 -mt-20" />
      <div className="absolute bottom-0 left-0 w-80 h-80 bg-blue-100/40 rounded-full blur-3xl -ms-20 -mb-20" />
